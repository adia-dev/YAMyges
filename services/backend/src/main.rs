...
async fn main() {
    ...
    let username: String = std::env::var("KORDIS_USERNAME")
        .expect("KORDIS_USERNAME must be set.");


    let password: String = std::env::var("KORDIS_PASSWORD")
        .expect("KORDIS_PASSWORD must be set.");
